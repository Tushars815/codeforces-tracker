...
export const selectSubmissionList = (state: StateInterface): SubmissionType[] =>
  state.fetchData.submissionList;
export const selectQuestionMap = (state: StateInterface): QuestionMapType =>
  state.fetchData.questionMap;
export const selectUserInfo = (state: StateInterface): UserInfoType =>
  state.fetchData.userInfo;
export const selectContestData = (state: StateInterface): ContestListType[] =>
  state.fetchData.contestData;
export const selectApiFetched = (state: StateInterface): boolean =>
  state.fetchData.apiFetched;
